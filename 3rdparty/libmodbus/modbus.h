...
EXPORT void modbus_set_app_softversion(modbus_t *ctx, unsigned char ver);
EXPORT void modbus_set_app_hardversion(modbus_t *ctx, unsigned char ver);
EXPORT void modbus_set_app_status(modbus_t *ctx, int status);
...
// *** Add DimSun for KPA_BITS projects

#define MODBUS_SET_INT32_TO_INT16(tab_int16, index, value) \
    do{\
    tab_int16[(index)] = (value) >> 16;\
    tab_int16[(index) + 1] = (value) & 0xFFFF;\
    } while(0)
